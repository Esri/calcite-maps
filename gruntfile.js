...
module.exports = function (grunt) {  
	...
	grunt.initConfig({  
		...
		'sass': {
			...
			expanded: {
				files: {
					'dist/css/calcite-maps-bootstrap-v0.3.css': 'lib/sass/build-calcite-maps-bootstrap.scss',
		...
		cssmin: {  
			target: {
				...
				files: {
					...
					'dist/css/calcite-maps-bootstrap.min-v0.3.css': ['dist/css/calcite-maps-bootstrap-v0.3.css'],
